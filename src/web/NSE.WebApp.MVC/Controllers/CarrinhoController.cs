...
namespace NSE.WebApp.MVC.Controllers
{
    ...
    public class CarrinhoController : MainController
    {
        ...
        public CarrinhoController(IComprasBffService comprasBffService) => _comprasBffService = comprasBffService;
        ...
        public async Task<IActionResult> AdicionarItemCarrinho([FromForm] ItemCarrinhoViewModel itemCarrinho)
        {
